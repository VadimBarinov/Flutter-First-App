import 'package:crypto_coins_list/features/crypto_coin/bloc/bloc/crypto_coin_details_bloc.dart';
                  ...
                  BaseCard(
                    child: Column(
                      children: [
                        _DataRow(
                          title: 'Hight 24 Hour',
                          value: '${coinDetails.hight24Hour.toString().substring(0, 12)} \$',
                        ),
                        const SizedBox(height: 6),
                        _DataRow(
                          title: 'Low 24 Hour',
                          value: '${coinDetails.low24Hours.toString().substring(0, 12)} \$',
                        ),
                      ],
                    ),
                  ),
